...
// ../netlify/functions/create-signed-url.ts
var create_signed_url_exports = {};
__export(create_signed_url_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(create_signed_url_exports);

// ../netlify/functions/node_modules/pinata/dist/index.mjs
...
// ../netlify/functions/pinata-utils.ts
var pinata = new PinataSDK({
  pinataJwt: process.env.PINATA_JWT,
  pinataGateway: "example-gateway.mypinata.cloud"
});
async function createSignedUploadUrl(expires = 3600, mimeTypes) {
  try {
    const options = {
      expires
    };
...
//# sourceMappingURL=create-signed-url.js.map
