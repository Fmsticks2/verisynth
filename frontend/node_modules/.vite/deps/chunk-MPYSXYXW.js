...
} from "./chunk-J2HAQBMU.js";
import {
  require_react
} from "./chunk-W4575UAP.js";
import {
  __commonJS,
  __toESM
...
async function fetchEnsAddress({
  ...
  const { normalize } = await import("./ens-JCY4CQH5.js");
  const publicClient = getPublicClient({ chainId });
...
function useConfig() {
  const config2 = React2.useContext(Context);
  if (!config2)
    throw new Error(
      [
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MPYSXYXW.js.map
